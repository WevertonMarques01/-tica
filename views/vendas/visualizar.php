...
try {
    ...
    try {
        ...
        // Tabela itens_venda pode nÃ£o existir
        error_log("Aviso: Tabela itens_venda nÃ£o encontrada: " . $e->getMessage());
    }
...
<head>
    ...
    <title>Detalhes da Venda #<?php echo $venda['id']; ?> - Ã“tica</title>
    ...
    <div class="min-h-screen">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="card p-6 mb-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">InformaÃ§Ãµes da Venda</h2>
            ...
            <div class="card p-6 mb-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">InformaÃ§Ãµes do Cliente</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nome</label>
                        <p class="mt-1 text-sm text-gray-900 dark:text-white">
                            <?php echo htmlspecialchars($venda['cliente_nome'] ?? 'Cliente nÃ£o encontrado'); ?>
                        </p>
                    </div>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                    <?php echo htmlspecialchars($item['produto_nome'] ?? 'Produto nÃ£o encontrado'); ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
