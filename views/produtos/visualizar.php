...
try {
    ...
    // Buscar estatÃ­sticas relacionadas ao produto
    $estatisticas = [
        'vendas' => 0,
        'movimentacoes' => 0,
    ...
    // Contar movimentaÃ§Ãµes de estoque
    try {
...
<head>
    ...
    <title>Produto: <?php echo htmlspecialchars($produto['nome']); ?> - Ã“tica</title>
    ...
    <div class="min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-6">
                    ...
                    <div class="flex items-center space-x-4">
                         <a href="novo.php?id=<?php echo $produto['id']; ?>" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-medium transition-colors">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="card p-6 bg-purple-600 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-medium">MovimentaÃ§Ãµes</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">InformaÃ§Ãµes BÃ¡sicas</h2>
                    <div class="space-y-4">
                        <div>
                ...
                <!-- PreÃ§os e Estoque -->
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">PreÃ§os e Estoque</h2>
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <?php if (isset($produto['preco_custo'])): ?>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">PreÃ§o de Custo</label>
                                <p class="mt-1 text-sm text-gray-900">R$ <?php echo number_format($produto['preco_custo'], 2, ',', '.'); ?></p>
                            </div>
                            <?php endif; ?>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">PreÃ§o de Venda</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">PreÃ§o Promocional</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Estoque MÃ­nimo</label>
                ...
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Detalhes TÃ©cnicos</h2>
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                ...
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">InformaÃ§Ãµes do Sistema</h2>
                    <div class="space-y-4">
                        <div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">CÃ³digo de Barras</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Ãšltima AtualizaÃ§Ã£o</label>
                            <p class="mt-1 text-sm text-gray-900">
