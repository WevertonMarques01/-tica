...
<div class="card">
    ...
    <form method="POST" action="salvar.php" enctype="multipart/form-data" id="uploadForm" class="space-y-6">
        ...
        <div>
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
                ...
                <label for="comprovante" class="cursor-pointer">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Formatos: JPG, PNG, GIF, PDF (mÃ¡x 10MB)</p>
                </label>
        ...
        <div>
            ...
            <textarea name="descricao" class="input" rows="3" placeholder="Ex: Pagamento da parcela 1/3 - Ã“culos de grau"></textarea>
        </div>
