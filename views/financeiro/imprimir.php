...
$periodo = "PerÃ­odo: " . date('d/m/Y', strtotime($data_inicio)) . " a " . date('d/m/Y', strtotime($data_fim));
?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>RelatÃ³rio Financeiro - <?php echo $periodo; ?></title>
...
<body>
    ...
    <table class="stats">
        <tr>
            ...
            <td class="stat-label">MÃ©dia por Venda</td>
        </tr>
        <tr>
    ...
    <?php if (empty($vendas)): ?>
    <p style="text-align: center; color: #666; padding: 30px;">Nenhuma venda no perÃ­odo informado.</p>
    <?php else: ?>
    <table class="table">
        <thead>
            <tr>
