...
$moduleName = 'Visualize o financeiro do perÃ­odo';
...
<div class="card">
    ...
    <div class="flex gap-2 mb-6">
        ...
        <a href="?data_inicio=<?php echo date('Y-m-01'); ?>&data_fim=<?php echo date('Y-m-t'); ?>" class="text-sm text-blue-600 hover:underline">Este MÃªs</a>
        <span class="text-gray-300">|</span>
        ...
        <div class="stat-card purple" style="padding: 1.25rem;">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <div class="stat-label">MÃ©dia por Venda</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="empty-state">
        ...
        <p>NÃ£o foram encontradas vendas neste intervalo de datas.</p>
    </div>
    <?php else: ?>
