...
$tiposConsulta = ['AvaliaÃ§Ã£o', 'Retorno', 'AdaptaÃ§Ã£o', 'RevisÃ£o', 'EmergÃªncia'];
        ...
        .then(data => {
            ...
            <div class="agendamento-card ${data.status}">
                <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 1rem;">
                    <div>
                        ...
                        <p style="color: #64748b; font-size: 0.875rem;">
                            <i class="fas fa-phone"></i> ${data.cliente_telefone || 'NÃ£o informado'}
                        </p>
                    </div>
                    <span class="badge badge-${data.status === 'agendado' ? 'info' : (data.status === 'concluido' ? 'success' : 'danger')}">
                        ${data.status === 'agendado' ? 'Agendado' : (data.status === 'concluido' ? 'ConcluÃ­do' : 'Cancelado')}
                    </span>
                </div>
                ...
                <div style="margin-bottom: 1rem;">
                    <strong style="font-size: 0.875rem; color: #64748b;">ObservaÃ§Ãµes</strong>
