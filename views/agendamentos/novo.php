...
$tiposConsulta = ['Avalia̤̣o', 'Retorno', 'Adapta̤̣o', 'Reviṣo', 'Emerg̻ncia', 'Exame de Vista'];
    ...
    <div class="card">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="observacoes" class="form-input" rows="3" placeholder="Observa̵̤es adicionais..."></textarea>
            </div>
