...
$pageTitle = 'Agendamentos ConcluÃ­dos';
$moduleName = 'HistÃ³rico de consultas';
...
<div class="card">
    ...
    <div class="alert alert-success">
        <i class="fas fa-check-circle"></i>
        Agendamento marcado como concluÃ­do!
    </div>
    <?php endif; ?>
    ...
    <div class="empty-state">
        ...
        <h3>Nenhum agendamento concluÃ­do</h3>
        <p>Os agendamentos concluÃ­dos aparecerÃ£o aqui.</p>
    </div>
    <?php else: ?>
        ...
        .then(data => {
            ...
            <div class="agendamento-card" style="border-left-color: #10b981;">
                <div class="agendamento-info">
                    ...
                    <p><i class="fas fa-phone"></i> ${data.cliente_telefone || 'NÃ£o informado'}</p>
                </div>
            ...
            <div style="margin-top: 1rem;">
                ...
                ${data.observacoes ? '<p><strong>ObservaÃ§Ãµes:</strong> ' + data.observacoes + '</p>' : ''}
                <p><strong>Status:</strong> <span class="badge badge-success">ConcluÃ­do</span></p>
            </div>
