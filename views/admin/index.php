...
$moduleName = 'Bem-vindo ao Wiz Ã“ptica';
...
<head>
    ...
    <title><?php echo $pageTitle; ?> - Wiz Ã“ptica</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="menu-scroll">
            ...
            <div class="menu-group">
                <p class="menu-title">ServiÃ§os</p>
            ...
            <div class="menu-group">
                ...
                <a href="../comprovantes/index.php" class="menu-item">
    ...
    <main class="main-content">
        ...
        <header class="page-header">
            ...
            <div class="user-info">
                ...
                <div class="user-name"><?php echo htmlspecialchars($_SESSION['usuario_nome'] ?? 'UsuÃ¡rio'); ?></div>
            </div>
        </header>
        ...
        <div class="grid-2">
            ...
            <div class="card">
                ...
                <div class="text-center py-4">
                    ...
                    <p class="text-gray-500">Total de vendas este mÃªs</p>
                </div>
            </div>
        </div>
