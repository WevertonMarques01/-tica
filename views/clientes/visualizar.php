...
try {
    ...
    // Buscar estatÃ­sticas relacionadas ao cliente
    $estatisticas = [
        'vendas' => 0,
        'receitas' => 0,
        'ordens_servico' => 0,
    ...
    try {
        ...
        error_log("Aviso: Tabela receitas nÃ£o encontrada: " . $e->getMessage());
    }
    
    // Contar ordens de serviÃ§o
    try {
        ...
        error_log("Aviso: Tabela ordens_servico nÃ£o encontrada: " . $e->getMessage());
    }
...
<head>
    ...
    <title>Cliente: <?php echo htmlspecialchars($cliente['nome']); ?> - Ã“tica</title>
    ...
    <div class="min-h-screen">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="card p-6 bg-orange-600 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-medium">Ordens de ServiÃ§o</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">InformaÃ§Ãµes Pessoais</h2>
                    <div class="space-y-4">
                        <div>
                ...
                <!-- Contato -->
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">InformaÃ§Ãµes de Contato</h2>
                    <div class="space-y-4">
                ...
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">EndereÃ§o</h2>
                    <div class="space-y-4">
                        <?php if (!empty($cliente['endereco'])): ?>
                        <div class="grid grid-cols-3 gap-4">
                            <div class="col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">EndereÃ§o</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">NÃºmero</label>
                ...
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">ObservaÃ§Ãµes</h2>
                ...
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">InformaÃ§Ãµes do Sistema</h2>
                    <div class="space-y-4">
                        <div>
