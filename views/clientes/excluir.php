...
try {
    ...
    // Verificar se hÃ¡ vendas relacionadas ao cliente
    ...
    // Verificar se hÃ¡ receitas relacionadas ao cliente
    try {
        ...
        // Tabela receitas pode nÃ£o existir
        error_log("Aviso: Tabela receitas nÃ£o encontrada: " . $e->getMessage());
    }
    
    // Verificar se hÃ¡ ordens de serviÃ§o relacionadas ao cliente
    try {
        ...
        // Tabela ordens_servico pode nÃ£o existir
        error_log("Aviso: Tabela ordens_servico nÃ£o encontrada: " . $e->getMessage());
    }
    
    // Excluir o cliente (apÃ³s verificar que nÃ£o hÃ¡ dados relacionados)
    ...
    if ($result) {
        ...
        try {
            ...
            $logStmt->execute([$_SESSION['usuario_id'], 'cliente_excluido', "Cliente ID: $id ({$cliente['nome']}) excluÃ­do"]);
        } catch (PDOException $e) {
