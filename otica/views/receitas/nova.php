...
$moduleName = 'Cadastre uma nova receita óptica';
...
<div class="card">
    <form method="POST" class="space-y-6">
        ...
        <div class="receita-grid">
            ...
            <div class="olho-section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="adicao_od" class="form-label">Adição</label>
            ...
            <div class="olho-section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="adicao_oe" class="form-label">Adição</label>
        ...
        <div class="form-group">
            ...
            <textarea name="observacoes" id="observacoes" rows="3" class="form-input" placeholder="Observações adicionais..."></textarea>
        </div>
