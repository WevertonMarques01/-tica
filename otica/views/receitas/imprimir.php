...
<head>
    <meta charset="UTF-8">
    <title>Receita Óptica - #<?php echo $receita['id']; ?></title>
    ...
    <div class="receita-grid">
        <div class="olho">
            ...
            <table>
                ...
                <tr><th>Adição</th><td><?php echo !empty($receita['adicao_od']) ? $receita['adicao_od'] : '-'; ?></td></tr>
        ...
        <div class="olho">
            ...
            <table>
                ...
                <tr><th>Adição</th><td><?php echo !empty($receita['adicao_oe']) ? $receita['adicao_oe'] : '-'; ?></td></tr>
