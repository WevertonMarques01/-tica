...
<div class="card">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
            <h2 class="text-lg font-semibold mb-4">Visualização do Comprovante</h2>
            ...
            <div class="bg-gray-100 rounded-lg p-4 min-h-[400px] flex items-center justify-center">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-gray-500">Visualização não disponível</p>
                </div>
                <?php endif; ?>
            </div>
        ...
        <div>
            <h2 class="text-lg font-semibold mb-4">Informações do Comprovante</h2>
            ...
            <div class="space-y-4">
                ...
                <div class="p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p class="mt-1 text-2xl font-bold text-green-800">
                        <?php echo $comprovante['valor_pagamento'] ? 'R$ ' . number_format($comprovante['valor_pagamento'], 2, ',', '.') : 'Não informado'; ?>
                    </p>
                </div>
