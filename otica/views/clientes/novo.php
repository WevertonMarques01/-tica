                ...
                <form method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="endereco" id="endereco" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-otica-primary focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"><?php echo htmlspecialchars($_POST['endereco'] ?? ''); ?></textarea>
                    </div>
