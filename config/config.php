...
define('SITE_NAME', 'Wiz Óptica');

// URL base do site (raiz do projeto)
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https://' : 'http://';
$host = $_SERVER['HTTP_HOST'] ?? 'localhost';
define('SITE_URL', $protocol . $host . '/');

// Se o projeto estiver em uma subpasta (ex: exemplo.com/otica/), descomente e ajuste:
// define('SITE_URL', $protocol . $host . '/otica/');
